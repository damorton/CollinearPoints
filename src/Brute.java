...
public class Brute {
	...
	/**
	 * Main iterates through each point and checks if any are collinear. If the
	 * point is collinear to the last it moves to the next point until a line
	 * segment is found.
	 * 
	 * @param args is the filename used to read the points coordinates.
	 */
	public static void main(String[] args) {

		canvasSetup(); // set up the canvas
		Point[] points = readFile(args); // read points from a file and create
											// an array
